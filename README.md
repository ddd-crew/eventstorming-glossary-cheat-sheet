...
**Command/Action**  
Represents decisions, actions or intent. They can be initiated by an actor or from an automated process. During process EventStorming usually, the word Action works better with stakeholders than command. We officially use a blue coloured post-it for it.
